...
const NoUserFound = ({ clearFilters }: { clearFilters: () => void }) => {
    return (
        <div className="flex flex-col items-center justify-center text-center py-20 space-y-4 text-gray-600">
            ...
            <h2 className="text-xl font-semibold text-gray-800">No Riders Found</h2>
            <p className="text-gray-500 max-w-xs">
                We couldn't find any riders matching your search criteria. <br /> Try adjusting your filters.
            </p>
